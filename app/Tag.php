...
{
    /**
     * Protection against mass assignments
     */
    protected $fillable = [
        'tag', 'title', 'subtitle', 'page_image', 'meta_description',
        'reverse_direction', 'layout'
    ];
    ...
    /**
     * Create a new Tag from the submitted form request.
     *
     * @param array $request
     * @return static
     */
    public static function createNewTag(array $request)
    {
        $tag = static::create($request);
